...
const NewWatches = () => {
  ...
  const newModels = [
    {
      ...
      price: 62000,
      imgSrc:
        "https://xdzksswqqqoonxbwcmup.supabase.co/storage/v1/object/sign/Images/green.webp?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJJbWFnZXMvZ3JlZW4ud2VicCIsImlhdCI6MTc0NDMxMjIzNiwiZXhwIjoxNzc1ODQ4MjM2fQ.m82qub0H3wh9Z778YLknmeV79_j_uFa3xkzsHOpQf4g",
    ...
    },
    {
      ...
      price: 47000,
      imgSrc:
        "https://xdzksswqqqoonxbwcmup.supabase.co/storage/v1/object/sign/Images/oyster.avif?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJJbWFnZXMvb3lzdGVyLmF2aWYiLCJpYXQiOjE3NDQzMTIxOTUsImV4cCI6MTc3NTg0ODE5NX0.71wCWGpaK0gwLgcUCFw5Ul7EbA0qla3Z6gjvaZ1mBvo",
      videoSrc:
        "public/videos/Rolex new watches 2025 – The Oyster Perpetual.mp4",
      description: t("oysterPerpetualDescription"),
      features: [
        t("superlativeChronometer"),
        t("colorfulDial"),
        t("paramagneticEscapeWheel"),
      ],
    ...
    },
    {
      ...
      price: 89500,
      imgSrc:
        "https://xdzksswqqqoonxbwcmup.supabase.co/storage/v1/object/sign/Images/1908.avif?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJJbWFnZXMvMTkwOC5hdmlmIiwiaWF0IjoxNzQ0MzEyMTYwLCJleHAiOjE3NzU4NDgxNjB9.Bzb39Zwj1Y-r9_zqDOObHKOt4yjxk574x_Vl90cmbu8",
    ...
    },
    {
      ...
      price: 53000,
      imgSrc:
        "https://xdzksswqqqoonxbwcmup.supabase.co/storage/v1/object/sign/Images/date2025.webp?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJJbWFnZXMvZGF0ZTIwMjUud2VicCIsImlhdCI6MTc0NDMxMjI1OSwiZXhwIjoxNzc1ODQ4MjU5fQ.QDtb9c3Y3Fm4wmP6Bc67sJNhuHQ6cK6pYJrxcqF5ie0",
  ...
  return (
    <section
      className={`${styles.newWatchesSection} ${
      ...
      <div className={styles.container}>
        ...
        <div className={styles.watchesGrid}>
          {newModels.map((model, index) => (
            <motion.div
              key={model.id}
              className={`${styles.watchCard} ${styles[model.colorClass]}`}
                ...
                <div className={styles.cardFront}>
                  <div className={styles.mediaContainer}>
                    ...
                    <div
                      ...
                      onClick={(e) => handleAddToFavorites(e, model)}
                    >
                      {inWishlist(model.id) ? (
                    ...
                    <div className={styles.releaseYearBadge}>
                      {model.release}
                    </div>
                  </div>
                ...
                <div className={styles.cardBack}>
                  ...
                  <div className={styles.watchDetails}>
                    ...
                    <div className={styles.priceInfoBack}>
                      ...
                      <span className={styles.priceValueBack}>
                        ${model.price.toLocaleString()}
                      </span>
                    </div>
                    ...
                    <div className={styles.availabilityInfo}>
                      {model.limited ? (
                        <span className={styles.limitedInfo}>
                          {t("limitedTo")}{" "}
                          <strong>{model.limitedQuantity}</strong> {t("pieces")}
                        </span>
                      ) : (
                        <span className={styles.regularRelease}>
                          {t("regularRelease")}
                        </span>
                      )}
                    </div>
                  ...
                  <div
                    id={`favorite-${model.id}-back`}
                    className={styles.favoriteButtonBack}
                    onClick={(e) => handleAddToFavorites(e, model)}
                  >
                    {inWishlist(model.id) ? (
                      <>
